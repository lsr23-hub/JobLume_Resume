 ...
 * 中国行政区划（省 / 市 两级）。
 *
 * 数据来源：国家统计局公开的行政区划代码（经 modood/Administrative-divisions-of-China
 * 整理）。仅保留省与市两级 —— 简历上的所在地写到市级已经足够，
 * 带上区县会让数据体积从 30KB 涨到 180KB。
 *
 * 直辖市的「市」与「省」同名；港澳台数据该数据集未含，此处手工补齐。
 */
...
export const CHINA_REGIONS: readonly Province[] = [
  { name: "北京市", cities: ["北京市"] },
  { name: "天津市", cities: ["天津市"] },
  ...
  { name: "台湾省", cities: ["台北市", "新北市", "台中市", "台南市", "高雄市", "其他"] },
] as const;
